...
select current_setting('server_version_num')::integer >= 120000 as postgres_dba_pgvers_12plus \gset
select current_setting('server_version_num')::integer >= 110000 as postgres_dba_pgvers_11plus \gset
