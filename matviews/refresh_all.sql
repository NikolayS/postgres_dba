...
-- List of special matviews that should be refreshed for optimal performance:
-- - mv_timezone_names: Caches pg_timezone_names for faster access

-- set this to TRUE here if you need ALL matviews to be refrehsed, not only those that already have been refreshed
