...
-- For timezone_names_cache, use the dedicated refresh script in refresh_timezone_cache.sql
-- since it's a performance-critical cache that may need more frequent updates.
